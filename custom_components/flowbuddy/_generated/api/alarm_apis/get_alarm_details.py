...
) -> AlarmOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = AlarmOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AlarmOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AlarmOutputModel | RestErrorResponse
    """
