...
from ...models.alarm_set_to_pending_post_input_model import AlarmSetToPendingPostInputModel
...
def _get_kwargs(
    alarm_id: str,
    *,
    body: AlarmSetToPendingPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/alarms/{alarm_id}/setToPending".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command setToPending
