...
from ...models.paginated_response_alarm_output_list_model import (
...
def _get_kwargs(
    *,
    ...
    event_type_any_of: str | Unset = UNSET,
    page: int | Unset = 1,
    ...
    params["descriptionContains"] = description_contains
    ...
    params["eventTypeAnyOf"] = event_type_any_of
...
) -> PaginatedResponseAlarmOutputListModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = PaginatedResponseAlarmOutputListModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedResponseAlarmOutputListModel | RestErrorResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        PaginatedResponseAlarmOutputListModel | RestErrorResponse
    """
