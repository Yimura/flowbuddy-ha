...
from ...models.alarm_set_to_closed_post_input_model import AlarmSetToClosedPostInputModel
...
def _get_kwargs(
    alarm_id: str,
    *,
    body: AlarmSetToClosedPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/alarms/{alarm_id}/setToClosed".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command setToClosed
