...
from ...models.alarm_add_comment_post_input_model import AlarmAddCommentPostInputModel
...
def _get_kwargs(
    alarm_id: str,
    *,
    body: AlarmAddCommentPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/alarms/{alarm_id}/addComment".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command addComment
