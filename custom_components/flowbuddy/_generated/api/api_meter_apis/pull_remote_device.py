...
from ...models.api_meter_pull_remote_device_post_input_model import (
...
def _get_kwargs(
    *,
    body: ApiMeterPullRemoteDevicePostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/apimeters/pullRemoteDevice",
    }
...
def sync_detailed(
    *,
    ...
    """Executing the command pullRemoteDevice
