...
from ...models.api_meter_create_remote_device_post_input_model import (
...
def _get_kwargs(
    *,
    body: ApiMeterCreateRemoteDevicePostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/apimeters/createRemoteDevice",
    }
...
def sync_detailed(
    *,
    ...
    """Executing the command createRemoteDevice
