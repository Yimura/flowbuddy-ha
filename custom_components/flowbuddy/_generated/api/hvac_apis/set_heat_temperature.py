...
from ...models.hvac_set_heat_temperature_post_input_model import (
...
def _get_kwargs(
    h_vac_id: str,
    *,
    body: HVACSetHeatTemperaturePostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/hvacs/{h_vac_id}/setHeatTemperature".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command setHeatTemperature
