...
from ...models.hvac_set_cool_temperature_post_input_model import (
...
def _get_kwargs(
    h_vac_id: str,
    *,
    body: HVACSetCoolTemperaturePostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/hvacs/{h_vac_id}/setCoolTemperature".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command setCoolTemperature
