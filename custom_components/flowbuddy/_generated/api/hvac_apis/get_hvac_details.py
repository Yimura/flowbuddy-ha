...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/hvacs/{h_vac_id}".format(
            h_vac_id=quote(str(h_vac_id), safe=""),
        ),
    }
...
) -> HVACOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = HVACOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HVACOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        HVACOutputModel | RestErrorResponse
    """
