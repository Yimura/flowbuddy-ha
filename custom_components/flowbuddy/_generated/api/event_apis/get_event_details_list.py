...
from ...models.paginated_response_event_output_list_model import (
...
) -> PaginatedResponseEventOutputListModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = PaginatedResponseEventOutputListModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedResponseEventOutputListModel | RestErrorResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        PaginatedResponseEventOutputListModel | RestErrorResponse
    """
