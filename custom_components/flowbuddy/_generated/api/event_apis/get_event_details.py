...
) -> EventOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = EventOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EventOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EventOutputModel | RestErrorResponse
    """
