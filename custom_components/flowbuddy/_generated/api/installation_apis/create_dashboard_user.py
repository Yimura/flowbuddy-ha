...
from ...models.installation_create_dashboard_user_post_input_model import (
...
def _get_kwargs(
    installation_id: str,
    *,
    body: InstallationCreateDashboardUserPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installations/{installation_id}/createDashboardUser".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command createDashboardUser
