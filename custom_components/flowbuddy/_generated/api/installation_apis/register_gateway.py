...
from ...models.installation_register_gateway_post_input_model import (
...
def _get_kwargs(
    installation_id: str,
    *,
    body: InstallationRegisterGatewayPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installations/{installation_id}/registerGateway".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command registerGateway
