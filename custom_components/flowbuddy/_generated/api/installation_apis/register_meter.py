...
from ...models.installation_register_meter_post_input_model import (
...
def _get_kwargs(
    installation_id: str,
    *,
    body: InstallationRegisterMeterPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installations/{installation_id}/registerMeter".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command registerMeter
