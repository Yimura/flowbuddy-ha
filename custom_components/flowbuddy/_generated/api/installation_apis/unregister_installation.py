...
from ...models.installation_unregister_installation_post_input_model import (
...
def _get_kwargs(
    installation_id: str,
    *,
    body: InstallationUnregisterInstallationPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installations/{installation_id}/unregisterInstallation".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command unregisterInstallation
