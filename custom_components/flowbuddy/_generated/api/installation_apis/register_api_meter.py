...
from ...models.installation_register_api_meter_post_input_model import (
...
def _get_kwargs(
    installation_id: str,
    *,
    body: InstallationRegisterApiMeterPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installations/{installation_id}/registerApiMeter".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command registerApiMeter
