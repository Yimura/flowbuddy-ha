...
from ...models.installation_assign_to_installation_pool_post_input_model import (
...
def _get_kwargs(
    installation_id: str,
    *,
    body: InstallationAssignToInstallationPoolPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installations/{installation_id}/assignToInstallationPool".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command assignToInstallationPool
