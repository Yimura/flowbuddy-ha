...
from ...models.installation_pool_patch_input_model import InstallationPoolPatchInputModel
...
def _get_kwargs(
    ...
    *,
    body: InstallationPoolPatchInputModel,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update an existing InstallationPool
