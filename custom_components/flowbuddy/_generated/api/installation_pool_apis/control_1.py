...
from ...models.installation_pool_control_post_input_model import (
...
def _get_kwargs(
    ...
    *,
    body: InstallationPoolControlPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/installationpools/{installation_pool_id}/control".format(
