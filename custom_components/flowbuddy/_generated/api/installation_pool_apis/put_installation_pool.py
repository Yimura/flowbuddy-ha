...
from ...models.installation_pool_put_input_model import InstallationPoolPutInputModel
...
def _get_kwargs(
    ...
    *,
    body: InstallationPoolPutInputModel,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing InstallationPool
