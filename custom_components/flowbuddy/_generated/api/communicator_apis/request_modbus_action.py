...
from ...models.communicator_request_modbus_action_post_input_model import (
...
def _get_kwargs(
    communicator_id: str,
    *,
    body: CommunicatorRequestModbusActionPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/communicators/{communicator_id}/requestModbusAction".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command requestModbusAction
