...
from ...models.communicator_request_verification_post_input_model import (
...
def _get_kwargs(
    communicator_id: str,
    *,
    body: CommunicatorRequestVerificationPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/communicators/{communicator_id}/requestVerification".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command requestVerification
