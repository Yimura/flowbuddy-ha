...
from ...models.communicator_request_heat_pump_test_post_input_model import (
...
def _get_kwargs(
    communicator_id: str,
    *,
    body: CommunicatorRequestHeatPumpTestPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/communicators/{communicator_id}/requestHeatPumpTest".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command requestHeatPumpTest
