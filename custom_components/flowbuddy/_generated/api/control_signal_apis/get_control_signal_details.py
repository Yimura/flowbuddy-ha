...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/controlsignals/{control_signal_id}".format(
...
) -> ControlSignalOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = ControlSignalOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ControlSignalOutputModel | RestErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve a single ControlSignal
...
def sync(
    ...
    *,
    ...
    Returns:
        ControlSignalOutputModel | RestErrorResponse
    """
