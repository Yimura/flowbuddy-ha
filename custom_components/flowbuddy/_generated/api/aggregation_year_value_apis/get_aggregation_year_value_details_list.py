...
from ...models.paginated_response_aggregation_year_value_output_list_model import (
...
) -> PaginatedResponseAggregationYearValueOutputListModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = PaginatedResponseAggregationYearValueOutputListModel.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedResponseAggregationYearValueOutputListModel | RestErrorResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Retrieve all AggregationYearValue objects
...
def sync(
    *,
    ...
    Returns:
        PaginatedResponseAggregationYearValueOutputListModel | RestErrorResponse
    """
