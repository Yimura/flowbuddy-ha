...
from ...models.paginated_response_instant_value_output_list_model import (
...
) -> PaginatedResponseInstantValueOutputListModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = PaginatedResponseInstantValueOutputListModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedResponseInstantValueOutputListModel | RestErrorResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Retrieve all InstantValue objects
...
def sync(
    *,
    ...
    Returns:
        PaginatedResponseInstantValueOutputListModel | RestErrorResponse
    """
