...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/inverters/{inverter_id}".format(
...
) -> InverterOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = InverterOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[InverterOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        InverterOutputModel | RestErrorResponse
    """
