...
from ...models.pv_report_patch_input_model import PvReportPatchInputModel
...
def _get_kwargs(
    pv_report_id: str,
    *,
    body: PvReportPatchInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/pvreports/{pv_report_id}".format(
            pv_report_id=quote(str(pv_report_id), safe=""),
        ),
    }
