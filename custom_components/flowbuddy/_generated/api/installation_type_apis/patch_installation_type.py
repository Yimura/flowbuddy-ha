...
from ...models.installation_type_patch_input_model import InstallationTypePatchInputModel
...
def _get_kwargs(
    ...
    *,
    body: InstallationTypePatchInputModel,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update an existing InstallationType
