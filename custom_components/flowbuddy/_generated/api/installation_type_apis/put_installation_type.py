...
from ...models.installation_type_put_input_model import InstallationTypePutInputModel
...
def _get_kwargs(
    ...
    *,
    body: InstallationTypePutInputModel,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Modify an existing InstallationType
