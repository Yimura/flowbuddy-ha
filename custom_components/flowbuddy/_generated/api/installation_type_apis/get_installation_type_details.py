...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/installationtypes/{installation_type_id}".format(
            installation_type_id=quote(str(installation_type_id), safe=""),
        ),
    }
...
) -> InstallationTypeOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = InstallationTypeOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[InstallationTypeOutputModel | RestErrorResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Retrieve a single InstallationType
...
def sync(
    ...
    *,
    ...
    Returns:
        InstallationTypeOutputModel | RestErrorResponse
    """
