...
from ...models.meter_control_post_input_model import MeterControlPostInputModel
...
def _get_kwargs(
    meter_id: str,
    *,
    body: MeterControlPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/meters/{meter_id}/control".format(
