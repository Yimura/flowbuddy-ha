...
) -> MeterOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = MeterOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[MeterOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        MeterOutputModel | RestErrorResponse
    """
