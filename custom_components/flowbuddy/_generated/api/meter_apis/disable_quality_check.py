...
from ...models.meter_disable_quality_check_post_input_model import (
...
def _get_kwargs(
    meter_id: str,
    *,
    body: MeterDisableQualityCheckPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/meters/{meter_id}/disableQualityCheck".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command disableQualityCheck
