...
from ...models.meter_register_measurement_post_input_model import (
...
def _get_kwargs(
    meter_id: str,
    *,
    body: MeterRegisterMeasurementPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/meters/{meter_id}/registerMeasurement".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command registerMeasurement
