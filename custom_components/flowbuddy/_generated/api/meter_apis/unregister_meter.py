...
from ...models.meter_unregister_meter_post_input_model import MeterUnregisterMeterPostInputModel
...
def _get_kwargs(
    meter_id: str,
    *,
    body: MeterUnregisterMeterPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/meters/{meter_id}/unregisterMeter".format(
            meter_id=quote(str(meter_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command unregisterMeter
