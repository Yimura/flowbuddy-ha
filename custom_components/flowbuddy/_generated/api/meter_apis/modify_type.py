...
from ...models.meter_modify_type_post_input_model import MeterModifyTypePostInputModel
...
def _get_kwargs(
    meter_id: str,
    *,
    body: MeterModifyTypePostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/meters/{meter_id}/modifyType".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command modifyType
