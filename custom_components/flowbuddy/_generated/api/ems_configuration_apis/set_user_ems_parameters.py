...
from ...models.ems_configuration_set_user_ems_parameters_post_input_model import (
...
def _get_kwargs(
    ...
    *,
    body: EmsConfigurationSetUserEmsParametersPostInputModel,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/emsconfigurations/{ems_configuration_id}/setUserEmsParameters".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Executing the command setUserEmsParameters
