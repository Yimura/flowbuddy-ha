...
from ...models.paginated_response_aggregation_month_value_output_list_model import (
...
) -> PaginatedResponseAggregationMonthValueOutputListModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = PaginatedResponseAggregationMonthValueOutputListModel.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedResponseAggregationMonthValueOutputListModel | RestErrorResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Retrieve all AggregationMonthValue objects
...
def sync(
    *,
    ...
    Returns:
        PaginatedResponseAggregationMonthValueOutputListModel | RestErrorResponse
    """
