...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/eventtypes/{event_type_id}".format(
...
) -> EventTypeOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = EventTypeOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[EventTypeOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        EventTypeOutputModel | RestErrorResponse
    """
