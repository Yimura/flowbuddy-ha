...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/batteries/{battery_id}".format(
...
) -> BatteryOutputModel | RestErrorResponse | None:
    if response.status_code == 200:
        response_200 = BatteryOutputModel.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BatteryOutputModel | RestErrorResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        BatteryOutputModel | RestErrorResponse
    """
