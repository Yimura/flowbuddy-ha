...
if TYPE_CHECKING:
    ...
    from ..models.pv_report_output_list_model import PvReportOutputListModel


T = TypeVar("T", bound="PaginatedResponsePvReportOutputListModel")


@_attrs_define
class PaginatedResponsePvReportOutputListModel:
    """
    Attributes:
        field_embedded (None | PvReportOutputListModel | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: None | PvReportOutputListModel | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, PvReportOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(data: object) -> None | PvReportOutputListModel | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = PvReportOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PvReportOutputListModel | Unset, data)
        ...
        paginated_response_pv_report_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_pv_report_output_list_model.additional_properties = d
        return paginated_response_pv_report_output_list_model
