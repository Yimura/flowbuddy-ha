...
class PaginatedResponsePvReportOutputListModel:
    """
    Attributes:
        field_embedded (PvReportOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: PvReportOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = PvReportOutputListModel.from_dict(_field_embedded)
