...
T = TypeVar("T", bound="SwitchIoPortOutputModel")


@_attrs_define
class SwitchIoPortOutputModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        switch_io_port_output_model = cls(
        ...
        switch_io_port_output_model.additional_properties = d
        return switch_io_port_output_model
