...
class PaginatedResponseLayoutOutputListModel:
    """
    Attributes:
        field_embedded (LayoutOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: LayoutOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = LayoutOutputListModel.from_dict(_field_embedded)
