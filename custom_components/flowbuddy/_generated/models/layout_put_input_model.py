...
if TYPE_CHECKING:
    from ..models.layout_put_input_model_other_properties_type_0 import (
...
class LayoutPutInputModel:
    ...
    Attributes:
        ...
        other_properties (LayoutPutInputModelOtherPropertiesType0 | None | Unset):
    """
    ...
    other_properties: LayoutPutInputModelOtherPropertiesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.other_properties, LayoutPutInputModelOtherPropertiesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_other_properties(
            data: object,
        ) -> LayoutPutInputModelOtherPropertiesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                other_properties_type_0 = LayoutPutInputModelOtherPropertiesType0.from_dict(data)

                return other_properties_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LayoutPutInputModelOtherPropertiesType0 | None | Unset, data)
