...
T = TypeVar("T", bound="ApiMeterTypeOutputModel")


@_attrs_define
class ApiMeterTypeOutputModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_meter_type_output_model = cls(
            resource_uri=resource_uri,
            name=name,
            external_id=external_id,
        )

        api_meter_type_output_model.additional_properties = d
        return api_meter_type_output_model
