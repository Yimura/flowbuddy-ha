...
if TYPE_CHECKING:
    from ..models.hvac_set_cool_temperature_post_input_model_other_properties import (
...
class HVACSetCoolTemperaturePostInputModel:
    ...
    Attributes:
        value (float | Unset):
        other_properties (HVACSetCoolTemperaturePostInputModelOtherProperties | Unset):
    """

    value: float | Unset = UNSET
    other_properties: HVACSetCoolTemperaturePostInputModelOtherProperties | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_other_properties, Unset):
            ...
            other_properties = HVACSetCoolTemperaturePostInputModelOtherProperties.from_dict(
                _other_properties
            )
