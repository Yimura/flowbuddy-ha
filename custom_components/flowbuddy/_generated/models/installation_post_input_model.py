...
if TYPE_CHECKING:
    from ..models.installation_post_input_model_other_properties import (
...
class InstallationPostInputModel:
    ...
    Attributes:
        ...
        other_properties (InstallationPostInputModelOtherProperties | Unset):
    """
    ...
    other_properties: InstallationPostInputModelOtherProperties | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_other_properties, Unset):
            ...
            other_properties = InstallationPostInputModelOtherProperties.from_dict(
                _other_properties
            )
