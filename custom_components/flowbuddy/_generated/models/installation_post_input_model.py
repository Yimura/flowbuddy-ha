...
if TYPE_CHECKING:
    from ..models.installation_post_input_model_other_properties_type_0 import (
        InstallationPostInputModelOtherPropertiesType0,
    )


T = TypeVar("T", bound="InstallationPostInputModel")


@_attrs_define
class InstallationPostInputModel:
    """
    Attributes:
        identification (str):
        uuid (None | str | Unset):
        ...
        other_properties (InstallationPostInputModelOtherPropertiesType0 | None | Unset):
    """
    ...
    other_properties: InstallationPostInputModelOtherPropertiesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.other_properties, InstallationPostInputModelOtherPropertiesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_other_properties(
            data: object,
        ) -> InstallationPostInputModelOtherPropertiesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                other_properties_type_0 = InstallationPostInputModelOtherPropertiesType0.from_dict(
                    data
                )
                ...
                pass
            return cast(InstallationPostInputModelOtherPropertiesType0 | None | Unset, data)

        other_properties = _parse_other_properties(d.pop("otherProperties", UNSET))

        installation_post_input_model = cls(
            identification=identification,
            uuid=uuid,
        ...
        installation_post_input_model.additional_properties = d
        return installation_post_input_model
