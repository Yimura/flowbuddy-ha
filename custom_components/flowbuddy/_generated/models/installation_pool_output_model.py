...
T = TypeVar("T", bound="InstallationPoolOutputModel")


@_attrs_define
class InstallationPoolOutputModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        installation_pool_output_model = cls(
            resource_uri=resource_uri,
            name=name,
            external_id=external_id,
        )

        installation_pool_output_model.additional_properties = d
        return installation_pool_output_model
