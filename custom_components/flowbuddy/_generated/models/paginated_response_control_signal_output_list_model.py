...
if TYPE_CHECKING:
    from ..models.control_signal_output_list_model import ControlSignalOutputListModel
    from ..models.links_model import LinksModel
    from ..models.page_model import PageModel


T = TypeVar("T", bound="PaginatedResponseControlSignalOutputListModel")


@_attrs_define
class PaginatedResponseControlSignalOutputListModel:
    """
    Attributes:
        field_embedded (ControlSignalOutputListModel | None | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: ControlSignalOutputListModel | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, ControlSignalOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(data: object) -> ControlSignalOutputListModel | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = ControlSignalOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ControlSignalOutputListModel | None | Unset, data)
        ...
        paginated_response_control_signal_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_control_signal_output_list_model.additional_properties = d
        return paginated_response_control_signal_output_list_model
