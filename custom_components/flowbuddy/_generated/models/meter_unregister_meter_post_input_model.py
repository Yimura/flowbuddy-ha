...
T = TypeVar("T", bound="MeterUnregisterMeterPostInputModel")
...
class MeterUnregisterMeterPostInputModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meter_unregister_meter_post_input_model.additional_properties = d
        return meter_unregister_meter_post_input_model
