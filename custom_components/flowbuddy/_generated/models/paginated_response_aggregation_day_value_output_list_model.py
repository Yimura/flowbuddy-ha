...
if TYPE_CHECKING:
    from ..models.aggregation_day_value_output_list_model import AggregationDayValueOutputListModel
    from ..models.links_model import LinksModel
    from ..models.page_model import PageModel


T = TypeVar("T", bound="PaginatedResponseAggregationDayValueOutputListModel")


@_attrs_define
class PaginatedResponseAggregationDayValueOutputListModel:
    """
    Attributes:
        field_embedded (AggregationDayValueOutputListModel | None | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: AggregationDayValueOutputListModel | None | Unset = UNSET
    field_links: LinksModel | None | Unset = UNSET
    field_page: None | PageModel | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.aggregation_day_value_output_list_model import (
        ...
        elif isinstance(self.field_embedded, AggregationDayValueOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(
            data: object,
        ) -> AggregationDayValueOutputListModel | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = AggregationDayValueOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AggregationDayValueOutputListModel | None | Unset, data)
        ...
        paginated_response_aggregation_day_value_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_aggregation_day_value_output_list_model.additional_properties = d
        return paginated_response_aggregation_day_value_output_list_model
