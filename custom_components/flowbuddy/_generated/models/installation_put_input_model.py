...
if TYPE_CHECKING:
    from ..models.installation_put_input_model_other_properties_type_0 import (
...
class InstallationPutInputModel:
    ...
    Attributes:
        ...
        other_properties (InstallationPutInputModelOtherPropertiesType0 | None | Unset):
    """
    ...
    other_properties: InstallationPutInputModelOtherPropertiesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.other_properties, InstallationPutInputModelOtherPropertiesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_other_properties(
            data: object,
        ) -> InstallationPutInputModelOtherPropertiesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                other_properties_type_0 = InstallationPutInputModelOtherPropertiesType0.from_dict(
                    data
                )
                ...
                pass
            return cast(InstallationPutInputModelOtherPropertiesType0 | None | Unset, data)
