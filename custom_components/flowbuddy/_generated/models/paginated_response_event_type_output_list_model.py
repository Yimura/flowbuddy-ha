...
class PaginatedResponseEventTypeOutputListModel:
    """
    Attributes:
        field_embedded (EventTypeOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: EventTypeOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = EventTypeOutputListModel.from_dict(_field_embedded)
