...
T = TypeVar("T", bound="SwitchBreakerOutputModel")


@_attrs_define
class SwitchBreakerOutputModel:
    """
    Attributes:
        resource_uri (None | str | Unset):
        entered_on (datetime.datetime | None | Unset):
        performed_on (datetime.datetime | None | Unset): De datum waarop de switch breaker succesvol werd uitgevoerd.
        status (None | str | Unset): De status waarin het command zich bevindt. Dit veld bepaalt door welke taak de
            switch breaker wordt gebruikt.
        result_message (None | str | Unset):
        breaker_on (bool | None | Unset): Het veld dat bepaald of de breaker aan of uit gezet wordt.
    ...
    breaker_on: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        breaker_on: bool | None | Unset
        if isinstance(self.breaker_on, Unset):
            breaker_on = UNSET
        else:
        ...
        if breaker_on is not UNSET:
            field_dict["breakerOn"] = breaker_on
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_breaker_on(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        breaker_on = _parse_breaker_on(d.pop("breakerOn", UNSET))
        ...
        switch_breaker_output_model = cls(
        ...
        switch_breaker_output_model.additional_properties = d
        return switch_breaker_output_model
