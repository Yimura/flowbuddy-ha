...
class SwitchBreakerOutputModel:
    ...
    Attributes:
        ...
        status (str | Unset): De status waarin het command zich bevindt. Dit veld bepaalt door welke taak de switch
            breaker wordt gebruikt.
        result_message (str | Unset):
        breaker_on (bool | Unset): Het veld dat bepaald of de breaker aan of uit gezet wordt.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        breaker_on = d.pop("breakerOn", UNSET)
