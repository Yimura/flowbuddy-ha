...
class PaginatedResponseApiMeasurementOutputListModel:
    """
    Attributes:
        field_embedded (ApiMeasurementOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: ApiMeasurementOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = ApiMeasurementOutputListModel.from_dict(_field_embedded)
