...
class PaginatedResponseHeatPumpControlTestOutputListModel:
    """
    Attributes:
        field_embedded (HeatPumpControlTestOutputListModel | None | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: HeatPumpControlTestOutputListModel | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, HeatPumpControlTestOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(
            data: object,
        ) -> HeatPumpControlTestOutputListModel | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = HeatPumpControlTestOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(HeatPumpControlTestOutputListModel | None | Unset, data)
