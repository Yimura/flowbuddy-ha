...
if TYPE_CHECKING:
    ...
    from ..models.switch_io_port_output_list_model import SwitchIoPortOutputListModel


T = TypeVar("T", bound="PaginatedResponseSwitchIoPortOutputListModel")


@_attrs_define
class PaginatedResponseSwitchIoPortOutputListModel:
    """
    Attributes:
        field_embedded (None | SwitchIoPortOutputListModel | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: None | SwitchIoPortOutputListModel | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, SwitchIoPortOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(data: object) -> None | SwitchIoPortOutputListModel | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = SwitchIoPortOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SwitchIoPortOutputListModel | Unset, data)
        ...
        paginated_response_switch_io_port_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_switch_io_port_output_list_model.additional_properties = d
        return paginated_response_switch_io_port_output_list_model
