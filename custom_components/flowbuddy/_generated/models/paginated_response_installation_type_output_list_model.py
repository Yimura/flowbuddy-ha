...
class PaginatedResponseInstallationTypeOutputListModel:
    """
    Attributes:
        field_embedded (InstallationTypeOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: InstallationTypeOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = InstallationTypeOutputListModel.from_dict(_field_embedded)
