...
if TYPE_CHECKING:
    from ..models.aggregation_year_value_output_list_model import (
...
T = TypeVar("T", bound="PaginatedResponseAggregationYearValueOutputListModel")


@_attrs_define
class PaginatedResponseAggregationYearValueOutputListModel:
    """
    Attributes:
        field_embedded (AggregationYearValueOutputListModel | None | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: AggregationYearValueOutputListModel | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, AggregationYearValueOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(
            data: object,
        ) -> AggregationYearValueOutputListModel | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = AggregationYearValueOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AggregationYearValueOutputListModel | None | Unset, data)
        ...
        paginated_response_aggregation_year_value_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_aggregation_year_value_output_list_model.additional_properties = d
        return paginated_response_aggregation_year_value_output_list_model
