...
if TYPE_CHECKING:
    from ..models.layout_patch_input_model_other_properties import (
...
class LayoutPatchInputModel:
    ...
    Attributes:
        ...
        other_properties (LayoutPatchInputModelOtherProperties | Unset):
    """
    ...
    other_properties: LayoutPatchInputModelOtherProperties | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_other_properties, Unset):
            ...
            other_properties = LayoutPatchInputModelOtherProperties.from_dict(_other_properties)
