...
if TYPE_CHECKING:
    from ..models.layout_patch_input_model_other_properties_type_0 import (
        LayoutPatchInputModelOtherPropertiesType0,
    )


T = TypeVar("T", bound="LayoutPatchInputModel")


@_attrs_define
class LayoutPatchInputModel:
    """
    Attributes:
        ...
        other_properties (LayoutPatchInputModelOtherPropertiesType0 | None | Unset):
    """
    ...
    other_properties: LayoutPatchInputModelOtherPropertiesType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.other_properties, LayoutPatchInputModelOtherPropertiesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_other_properties(
            data: object,
        ) -> LayoutPatchInputModelOtherPropertiesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                other_properties_type_0 = LayoutPatchInputModelOtherPropertiesType0.from_dict(data)

                return other_properties_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LayoutPatchInputModelOtherPropertiesType0 | None | Unset, data)

        other_properties = _parse_other_properties(d.pop("otherProperties", UNSET))

        layout_patch_input_model = cls(
            meter=meter,
        ...
        layout_patch_input_model.additional_properties = d
        return layout_patch_input_model
