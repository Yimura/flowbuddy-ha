...
class PaginatedResponseCommunicatorVerificationOutputListModel:
    """
    Attributes:
        field_embedded (CommunicatorVerificationOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: CommunicatorVerificationOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = CommunicatorVerificationOutputListModel.from_dict(_field_embedded)
