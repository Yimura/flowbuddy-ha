...
if TYPE_CHECKING:
    ...
    from ..models.measurement_output_list_model import MeasurementOutputListModel
    from ..models.page_model import PageModel


T = TypeVar("T", bound="PaginatedResponseMeasurementOutputListModel")


@_attrs_define
class PaginatedResponseMeasurementOutputListModel:
    """
    Attributes:
        field_embedded (MeasurementOutputListModel | None | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: MeasurementOutputListModel | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, MeasurementOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(data: object) -> MeasurementOutputListModel | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = MeasurementOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MeasurementOutputListModel | None | Unset, data)
        ...
        paginated_response_measurement_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_measurement_output_list_model.additional_properties = d
        return paginated_response_measurement_output_list_model
