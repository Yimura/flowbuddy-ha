...
if TYPE_CHECKING:
    ...
    from ..models.pv_production_test_output_list_model import PvProductionTestOutputListModel


T = TypeVar("T", bound="PaginatedResponsePvProductionTestOutputListModel")


@_attrs_define
class PaginatedResponsePvProductionTestOutputListModel:
    """
    Attributes:
        field_embedded (None | PvProductionTestOutputListModel | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: None | PvProductionTestOutputListModel | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.field_embedded, PvProductionTestOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(data: object) -> None | PvProductionTestOutputListModel | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = PvProductionTestOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PvProductionTestOutputListModel | Unset, data)
        ...
        paginated_response_pv_production_test_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_pv_production_test_output_list_model.additional_properties = d
        return paginated_response_pv_production_test_output_list_model
