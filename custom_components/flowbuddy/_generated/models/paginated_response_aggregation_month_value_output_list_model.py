...
if TYPE_CHECKING:
    from ..models.aggregation_month_value_output_list_model import (
...
T = TypeVar("T", bound="PaginatedResponseAggregationMonthValueOutputListModel")
...
class PaginatedResponseAggregationMonthValueOutputListModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_aggregation_month_value_output_list_model.additional_properties = d
        return paginated_response_aggregation_month_value_output_list_model
