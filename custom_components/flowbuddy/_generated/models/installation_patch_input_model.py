...
if TYPE_CHECKING:
    from ..models.installation_patch_input_model_other_properties import (
...
class InstallationPatchInputModel:
    ...
    Attributes:
        ...
        other_properties (InstallationPatchInputModelOtherProperties | Unset):
    """
    ...
    other_properties: InstallationPatchInputModelOtherProperties | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_other_properties, Unset):
            ...
            other_properties = InstallationPatchInputModelOtherProperties.from_dict(
                _other_properties
            )
