...
class PaginatedResponseClientUserGroupOutputListModel:
    """
    Attributes:
        field_embedded (ClientUserGroupOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: ClientUserGroupOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = ClientUserGroupOutputListModel.from_dict(_field_embedded)
