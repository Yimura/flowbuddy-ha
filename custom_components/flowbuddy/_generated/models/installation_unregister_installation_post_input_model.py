...
T = TypeVar("T", bound="InstallationUnregisterInstallationPostInputModel")
...
class InstallationUnregisterInstallationPostInputModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        installation_unregister_installation_post_input_model.additional_properties = d
        return installation_unregister_installation_post_input_model
