...
class PaginatedResponseApiMeterTypeOutputListModel:
    """
    Attributes:
        field_embedded (ApiMeterTypeOutputListModel | Unset):
        field_links (LinksModel | Unset):
        field_page (PageModel | Unset):
    """

    field_embedded: ApiMeterTypeOutputListModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_embedded, Unset):
            ...
            field_embedded = ApiMeterTypeOutputListModel.from_dict(_field_embedded)
