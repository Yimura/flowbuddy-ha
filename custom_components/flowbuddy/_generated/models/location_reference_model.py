...
T = TypeVar("T", bound="LocationReferenceModel")


@_attrs_define
class LocationReferenceModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        location_reference_model = cls(
            resource_uri=resource_uri,
            external_id=external_id,
        )

        location_reference_model.additional_properties = d
        return location_reference_model
