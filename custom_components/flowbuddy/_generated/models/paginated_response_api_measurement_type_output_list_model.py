...
if TYPE_CHECKING:
    from ..models.api_measurement_type_output_list_model import ApiMeasurementTypeOutputListModel
    from ..models.links_model import LinksModel
    from ..models.page_model import PageModel


T = TypeVar("T", bound="PaginatedResponseApiMeasurementTypeOutputListModel")


@_attrs_define
class PaginatedResponseApiMeasurementTypeOutputListModel:
    """
    Attributes:
        field_embedded (ApiMeasurementTypeOutputListModel | None | Unset):
        field_links (LinksModel | None | Unset):
        field_page (None | PageModel | Unset):
    """

    field_embedded: ApiMeasurementTypeOutputListModel | None | Unset = UNSET
    field_links: LinksModel | None | Unset = UNSET
    field_page: None | PageModel | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.api_measurement_type_output_list_model import (
        ...
        elif isinstance(self.field_embedded, ApiMeasurementTypeOutputListModel):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_field_embedded(data: object) -> ApiMeasurementTypeOutputListModel | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                field_embedded_type_1 = ApiMeasurementTypeOutputListModel.from_dict(data)

                return field_embedded_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ApiMeasurementTypeOutputListModel | None | Unset, data)
        ...
        paginated_response_api_measurement_type_output_list_model = cls(
            field_embedded=field_embedded,
            field_links=field_links,
            field_page=field_page,
        )

        paginated_response_api_measurement_type_output_list_model.additional_properties = d
        return paginated_response_api_measurement_type_output_list_model
